...
export const WEB_DEMO_ACCOUNTS = [
  ...
  { label: "Contractor", email: "contractor@fleetpilot.test", password: DEMO_PASSWORD, accent: "#8B5CF6" },
  ...
  { label: "Parent", email: "parent@fleetpilot.test", password: DEMO_PASSWORD, accent: "#6366F1" },
] as const;
